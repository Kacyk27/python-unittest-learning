...
from customers_db.customers import CustomerDB
...
class TestCustomerDB(unittest.TestCase):
    ...
    def test_find_customers_by_first_name(self):
        ...
        #act
        actual = tuple(db.find_customer_by_first_name("John"))
    ...
    def test_find_customer_by_country(self):
        # arrange
        db = CustomerDB(self.connection)
